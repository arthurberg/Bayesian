...
```{r, echo=FALSE}
knitr::include_url("https://glow.shinyapps.io/chengyu/",
  height = "325px")
```  
...
f.main1 = function(word_num,scores.current,words,guess_number,myguesses,myfeedback){
...
for(word_num in 1:n){
  ...
  for(i in 1:5){
    ...
    while(res=="keep guessing" & guess_number<=9){
      ...
      guess=f.main(word_num,scores.current,words,guess_number,myguesses,myfeedback)
